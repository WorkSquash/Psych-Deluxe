...
class OSTP4 extends MusicBeatState
{
	...
	function openSelectedSubstate(label:String) {
		switch(label) {
			case 'Debug':
				LoadingState.loadAndSwitchState(new states.FreeplayState());
		}
	}
	...
	override function create() {
		#if desktop
		DiscordClient.changePresence("Options Menu Page 4", null);
		#end
