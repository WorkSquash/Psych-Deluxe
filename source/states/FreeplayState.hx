...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...songs.length)
		{
			...
			if(songs[i].songCharacter == '' || songs[i].songCharacter == null) icon = new HealthIcon('blank'); //Load invis icon if songchar is nothing
			else icon = new HealthIcon(songs[i].songCharacter);
