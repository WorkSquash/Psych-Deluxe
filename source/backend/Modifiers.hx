...
class Modifiers
{
	...
	private var variable:String = null; //Variable from ClientPrefs.hx's Modifiers
	...
	{
		return ClientPrefs.data.modifiers.get(variable);
	}
	public function setValue(value:Dynamic)
	{
		ClientPrefs.data.modifiers.set(variable, value);
	}
