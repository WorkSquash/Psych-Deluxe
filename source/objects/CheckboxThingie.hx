...
class CheckboxThingie extends FlxSprite
{
	...
	public function new(x:Float = 0, y:Float = 0, ?checked = false) {
		...
		animation.addByPrefix("unchecked", "checkbox0", 30, false);
		animation.addByPrefix("unchecking", "checkbox anim reverse", 30, false);
		animation.addByPrefix("checking", "checkbox anim0", 30, false);
		animation.addByPrefix("checked", "checkbox finish", 30, false);
