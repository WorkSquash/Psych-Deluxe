...
import states.MainMenuState; //For version shits
...
class FPSCounter extends TextField
{
	...
	**/
	...
	public dynamic function updateText():Void { // so people can override it in hscript
		text = 'FPS: ${currentFPS}\n';
		#if desktop
		if(ClientPrefs.data.enableDebug){
			text += 'Memory Usage: ${flixel.util.FlxStringUtil.formatBytes(memoryMegas)}\n';
			text += 'Operating System: ${Sys.systemName()}\n';
		...
		if (currentFPS < FlxG.drawFramerate * 0.75) textColor = 0xFFFFFF00;
