...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	public function new(dialogueList:DialogueFile, ?song:String = null)
	{
		...
		box.animation.addByPrefix('normal', 'speech bubble normal', 60);
		box.animation.addByPrefix('normalOpen', 'Speech Bubble Normal Open', 60, false);
		box.animation.addByPrefix('angry', 'AHH speech bubble', 60);
		box.animation.addByPrefix('angryOpen', 'speech bubble loud open', 60, false);
		box.animation.addByPrefix('center-normal', 'speech bubble middle', 60);
		box.animation.addByPrefix('center-normalOpen', 'Speech Bubble Middle Open', 60, false);
		box.animation.addByPrefix('center-angry', 'AHH Speech Bubble middle', 60);
		box.animation.addByPrefix('center-angryOpen', 'speech bubble Middle loud open', 60, false);
